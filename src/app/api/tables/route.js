...
function sanitizeTableIdentifier(identifier) {
...
function buildTablePlaceholder(parts) {
...
async function fetchTableList({ schema, includeSystem }) {
  const params = []
  const predicates = ["table_type = 'BASE TABLE'"]
...
export async function GET(request) {
  ...
  try {
    ...
    const baseParams = [...identifierParts]
    let appliedLineId = null
    let appliedSince = since
    let rows
